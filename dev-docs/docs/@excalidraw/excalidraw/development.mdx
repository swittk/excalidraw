---
pagination_prev: "ex-excalidraw/installation"
---

# Development

This page relates to developing the `ex-excalidraw` package itself.

## Example app

To start the example app using the `ex-excalidraw` package, follow the below steps:
