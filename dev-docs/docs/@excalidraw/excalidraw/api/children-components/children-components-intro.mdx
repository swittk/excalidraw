...
slug: /ex-excalidraw/api/children-components
---
...
- [MainMenu](/docs/ex-excalidraw/api/children-components/main-menu)
- [WelcomeScreen](/docs/ex-excalidraw/api/children-components/welcome-screen)
- [Sidebar](/docs/ex-excalidraw/api/children-components/sidebar)
- [Footer](/docs/ex-excalidraw/api/children-components/footer)
- [LiveCollaborationTrigger](/docs/ex-excalidraw/api/children-components/live-collaboration-trigger)
