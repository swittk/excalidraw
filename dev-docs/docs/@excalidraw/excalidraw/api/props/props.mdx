...
| --- | --- | --- | --- |
| [`initialData`](/docs/ex-excalidraw/api/props/initialdata) | `object` &#124; `null` &#124; <code>Promise<object &#124; null></code> | `null` | The initial data with which app loads. |
| [`excalidrawAPI`](/docs/ex-excalidraw/api/props/excalidraw-api) | `function` | \_ | Callback triggered with the excalidraw api once rendered |
...
| [`renderTopRightUI`](/docs/ex-excalidraw/api/props/render-props#rendertoprightui) | `function` | \_ | Render function that renders custom UI in top right corner |
| [`renderCustomStats`](/docs/ex-excalidraw/api/props/render-props#rendercustomstats) | `function` | \_ | Render function that can be used to render custom stats on the stats dialog. |
...
| [`UIOptions`](/docs/ex-excalidraw/api/props/ui-options) | `object` | [DEFAULT UI OPTIONS](https://github.com/excalidraw/excalidraw/blob/master/packages/excalidraw/constants.ts#L151) | To customise UI options. Currently we support customising [`canvas actions`](/docs/ex-excalidraw/api/props/ui-options#canvasactions) |
...
| [`renderEmbeddable`](/docs/ex-excalidraw/api/props/render-props#renderEmbeddable) | `function` | \_ | Render function that can override the built-in `<iframe>` |
...
You can add `customData` to elements when passing them as [`initialData`](/docs/ex-excalidraw/api/props/initialdata), or using [`updateScene`](/docs/ex-excalidraw/api/props/excalidraw-api#updatescene) / [`updateLibrary`](/docs/ex-excalidraw/api/props/excalidraw-api#updatelibrary) afterwards.
...
You can use [`THEME`](/docs/ex-excalidraw/api/utils#theme) to specify the theme.
